...
C----------COMMON AREAS.
      COMMON /rates/  f,r(nrec)           !Reaction rates.
      COMMON /ratecoeff/  aa               ! rate parameters - NEW
      COMMON /evolp1/ t9,hv,phie,y(nnuc)  !Evolution parameters.

      COMMON /switcher/ switch

C==========================DECLARATION DIVISION=================================

C----------REACTION RATES.
      REAL    f(nrec)              !Forward reaction rate coefficients.
      REAL    aa(nrec,35)   ! REACLIB RATE parameters - 35 per reaction - NEW
...
C10--------TEMPERATURE FACTORS--------------------------------------------------
      ...
      t9m1  = 1/t9                 !t9**(-1)
      t913  = t9**onethrd           !t9**(1/3)
      t9m13  = 1/t913              !t9**(-1/3) [this is new!]
      t953  = t9*t913*t913         !t9**(5/3)

c     note that these other powers are NOT needed for the REACLIB rates
      ...
      END IF
      t9c13 = t9c**onethrd      !t9c**(1/3)
      t9c56 = t9c**fivsix      !t9c**(5/6)
      t9d   = t9/(1.+0.759*t9)     !For reaction 24.
      t9d13 = t9d**onethrd      !t9d**(1/3)
      t9d56 = t9d**fivsix       !t9d**(5/6)
      t9e   = t9/(1.+0.1378*t9)    !For reaction 26.
      t9e13 = t9e**onethrd      !t9e**(1/3)
      t9e56 = t9e**fivsix       !t9e**(5/6)
      t9f   = t9/(1.+0.1071*t9)    !For reaction 27.
      t9f13 = t9f**onethrd      !t9f**(1/3)
      t9f56 = t9f**fivsix       !t9f**(5/6)
...
C.......H(n,g)H2...................(Smith-Kawano-Malaney 1992)
       if(switch(12).eq.0) then

          f(12)  = 4.742e+4*(1.-.8504*t912+.4895*t9-.09623*t932
     |                     +8.471e-3*t9*t9-2.80e-4*t9*t932)
       else
          CALL THIEL (12,t9)      ! use the Thielmann formulation
       endif

C%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c         RATE KEPT THE SAME FOR APS MEETING CALCULATION
C%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%



C.......H2(n,g)H3..................(Wagoner 1969)
       if(switch(13).eq.0) then
          f(13)  = 6.62e+1*(1.+18.9*t9)
       else
          CALL THIEL (13,t9)      ! use the Thielmann formulation
       endif

C.......He3(n,g)He4................(Wagoner 1969)
       if(switch(14).eq.0) then
          f(14)  = 6.62e+0*(1.+905.*t9)
       else
          CALL THIEL (14,t9)      ! use the Thielmann formulation
       endif

C.......Li6(n,g)Li7................(Malaney-Fowler 1989)
       if(switch(15).eq.0) then
          f(15)  = 5.10e+3
       else
          CALL THIEL (15,t9)      ! use the Thielmann formulation
       endif
...
C.......Li6(p,a)He3................(Caughlan-Fowler 1988)
     ...
     |         + 1.29e+09*t9m1*ex(-21.820/t9)
          ...
          CALL THIEL (23,t9)      ! use the Thielmann formulation
       endif

C.......Li7(p,a)He4................(Smith-Kawano-Malaney 1992)
       if(switch(24).eq.0) then
     ...
     |         + 1.55e+6*t9m32*ex(-4.478/t9)
          ...
          CALL THIEL (24,t9)      ! use the Thielmann formulation
        endif ! switch
...
C.......H3(a,g)Li7.................(Smith-Kawano-Malaney 1992)
     ...
     |         + 5.109e+5*t9e56*t9m32*ex(-8.068/t9e13)
          ...
          CALL THIEL (26,t9)      ! use the Thielmann formulation
       endif

C.......He3(a,g)Be7................(Smith-Kawano-Malaney 1992)
       if(switch(27).eq.0) then
...
C10--------TEMPERATURE FACTORS--------------------------------------------------
      ...
      t9a13 = t9a**onethrd      !t9a**(1/3)
      t9a56 = t9a**fivsix      !t9a**(5/6)

C20--------NEUTRON, PHOTON REACTIONS--------------------------------------------

C.......Li7(n,g)Li8................(Wagoner 1969)
       if(switch(35).eq.0) then
          f(35)  = 4.90e+3 + 9.96e+3*t9m32*ex(-2.62/t9)
       else
          CALL THIEL (35,t9)      ! use the Thielmann formulation
       endif

C.......B10(n,g)B11................(Wagoner 1969)
       if(switch(36).eq.0) then
          f(36)  = 6.62e+4
       else
          CALL THIEL (36,t9)      ! use the Thielmann formulation
       endif

C.......B11(n,g)B12................(Malaney-Fowler 1989)
       if(switch(37).eq.0) then
          f(37)  = 7.29e+2 + 2.40e+3*t9m32*ex(-0.223/t9)
       else
          CALL THIEL (37,t9)      ! use the Thielmann formulation
       endif

C30--------NEUTRON, PROTON REACTIONS--------------------------------------------

C.......C11(n,p)B11................(Caughlan-Fowler 1988)
       if(switch(38).eq.0) then
          f(38)  = 1.69e+8*(1.-.048*t912+.010*t9)
       else
          CALL THIEL (38,t9)      ! use the Thielmann formulation
       endif

C40--------NEUTRON, ALPHA REACTIONS---------------------------------------------

C.......B10(n,a)Li7................(Caughlan-Fowler 1988)
       if(switch(39).eq.0) then
          f(39)  = 5.07e+8
       else
          CALL THIEL (39,t9)      ! use the Thielmann formulation
       endif

C50--------PROTON, PHOTON REACTIONS---------------------------------------------

C.......Be7(p,g)B8.................(Caughlan-Fowler 1988)
       if(switch(40).eq.0) then
          f(40)  = 3.11e+5*t9m23*ex(-10.262/t913)
     |         + 2.53e+3*t9m32*ex(-7.306/t9)
       else
          CALL THIEL (40,t9)      ! use the Thielmann formulation
       endif

C.......Be9(p,g)B10................(Caughlan-Fowler 1988)
       if(switch(41).eq.0) then
     ...
     |         + 2.72e+6*t9m32*ex(-10.620/t9)
          ...
          CALL THIEL (41,t9)      ! use the Thielmann formulation
       endif

C.......B10(p,g)C11................(Caughlan-Fowler 1988)
       if(switch(42).eq.0) then
     ...
     |         + 1.14e+4*t9m32*ex(-16.164/t9)
          ...
          CALL THIEL (42,t9)      ! use the Thielmann formulation
       endif

C.......B11(p,g)C12................(Caughlan-Fowler 1988)
       if(switch(43).eq.0) then
...
C.......Li6(a,g)B10................(Caughlan-Fowler 1988)
     ...
     |         + 1.01e+4*t9m1*ex(-7.269/t9)
          ...
          CALL THIEL (49,t9)      ! use the Thielmann formulation
       endif

C.......Li7(a,g)B11................(Caughlan-Fowler 1988)
       if(switch(50).eq.0) then
     ...
     |         + 4.10e+4*t9m1*ex(-6.227/t9)
          ...
          CALL THIEL (50,t9)      ! use the Thielmann formulation
       endif

C.......Be7(a,g)C11................(Caughlan-Fowler 1988)
       if(switch(51).eq.0) then
...
C.......B11(p,2a)He4...............(Caughlan-Fowler 1988)
     ...
     |         + 3.88e+9*t9m1*ex(-14.154/t9)
          ...
          CALL THIEL (63,t9)      ! use the Thielmann formulation
       endif

C.......C11(n,2a)He4...............(Wagoner 1969)
       if(switch(64).eq.0) then
          f(64)  = 1.58e+8
       else
          CALL THIEL (64,t9)      ! use the Thielmann formulation
       endif
...
C10--------TEMPERATURE FACTORS--------------------------------------------------
     ...
     |          /(1.+7.76e-2*t9+2.64e-2*t953/(1.+7.76e-2*t9)**(2./3.))
      t9b13 = t9b**onethrd     !t9b**(1/3)
      t9b56 = t9b**fivsix     !t9b**(5/6)

C20--------NEUTRON, PHOTON REACTIONS--------------------------------------------

C.......C12(n,g)C13................(Wagoner 1969)
       if(switch(65).eq.0) then
          f(65)  = 4.50e+2
       else
          CALL THIEL (65,t9)      ! use the Thielmann formulation
       endif

C.......C13(n,g)C14................(Wagoner 1969)
       if(switch(66).eq.0) then
          f(66)  = 1.19e+2 + 2.38e+5*t9m32*ex(-1.67/t9)
       else
          CALL THIEL (66,t9)      ! use the Thielmann formulation
       endif

C.......N14(n,g)N15................(Wagoner 1969)
       if(switch(67).eq.0) then
          f(67)  = 9.94e+3
       else
          CALL THIEL (67,t9)      ! use the Thielmann formulation
       endif

C30--------NEUTRON, PROTON REACTIONS--------------------------------------------

C.......N13(n,p)C13................(Caughlan-Fowler 1988)
       if(switch(68).eq.0) then
          f(68)  = 1.88e+8*(1.-.167*t912+.037*t9)
       else
          CALL THIEL (68,t9)      ! use the Thielmann formulation
       endif

C.......N14(n,p)C14................(Caughlan-Fowler 1988)
       if(switch(69).eq.0) then
          f(69)  = 2.39e+5*(1.+.361*t912+.502*t9)
     |         + 1.112e+8/t912*ex(-4.983/t9)
       else
          CALL THIEL (69,t9)      ! use the Thielmann formulation
       endif

C.......O15(n,p)N15................(Caughlan-Fowler 1988)
       if(switch(70).eq.0) then
          f(70)  = 3.50e+8*(1.+.452*t912-.191*t9)
       else
          CALL THIEL (70,t9)      ! use the Thielmann formulation
       endif

C40--------NEUTRON, ALPHA REACTIONS---------------------------------------------

C.......O15(n,a)C12................(Caughlan-Fowler 1988)
       if(switch(71).eq.0) then
          f(71)  = 3.50e+7*(1.+.188*t912+.015*t9)
       else
          CALL THIEL (71,t9)      ! use the Thielmann formulation
       endif

C50--------PROTON, PHOTON REACTIONS---------------------------------------------

C.......C12(p,g)N13................(Caughlan-Fowler 1988)
       if(switch(72).eq.0) then
...
C.......N14(p,g)O15................(Caughlan-Fowler 1988)
     ...
     |         + 2.19e+4*ex(-12.530/t9)
          ...
          CALL THIEL (76,t9)      ! use the Thielmann formulation
       endif

C.......N15(p,g)O16................(Caughlan-Fowler 1988)
       if(switch(77).eq.0) then
     ...
     |         + 3.80e+6*t9m32*ex(-11.048/t9)
          ...
          CALL THIEL (77,t9)      ! use the Thielmann formulation
       endif

C60--------PROTON, ALPHA REACTIONS----------------------------------------------

C.......N15(p,a)C12................(Caughlan-Fowler 1988)
       if(switch(78).eq.0) then
     ...
     |         + 2.20e+8*t9m32*ex(-11.418/t9)
          ...
          CALL THIEL (78,t9)      ! use the Thielmann formulation
       endif

C70--------ALPHA, PHOTON REACTIONS----------------------------------------------

C.......C12(a,g)O16................(Caughlan-Fowler 1988)
       if(switch(79).eq.0) then
     ...
     |         + 1.43e-2*(t9)**5*ex(-15.541/t9)
          ...
          CALL THIEL (79,t9)      ! use the Thielmann formulation
       endif

C80--------ALPHA, PROTON REACTIONS----------------------------------------------

C.......B10(a,p)C13................(Wagoner 1969)
       if(switch(80).eq.0) then
          f(80)  = 9.60e+14*t9m23*ex(-27.99/t913)
       else
          CALL THIEL (80,t9)      ! use the Thielmann formulation
       endif

C.......B11(a,p)C14................(Caughlan-Fowler 1988)
       if(switch(81).eq.0) then
...
C.......B11(a,n)N14................(Caughlan-Fowler 1988)
     ...
     |         + 4.49e+6*t935*ex(-8.596/t9)
          ...
          CALL THIEL (86,t9)      ! use the Thielmann formulation
       endif

C.......B12(a,n)N15................(Wagoner 1969)
       if(switch(87).eq.0) then
          f(87)  = 3.04e+15*t9m23*ex(-28.45/t913)
       else
          CALL THIEL (87,t9)      ! use the Thielmann formulation
       endif

C.......C13(a,n)O16................(Caughlan-Fowler 1988)
       if(switch(88).eq.0) then
     ...
     |         + 2.92e+9*t9m32*ex(-29.283/t9)
          ...
          CALL THIEL (88,t9)      ! use the Thielmann formulation
       endif
...
C========================IDENTIFICATION DIVISION=============================
      ...
      SUBROUTINE THIEL(jj,tt9)


C------------------NEW --------------

C----------LINKAGES.
C     CALLED BY - [subroutine] rate2
C     CALLS     - [function] ex

C----------REMARKS.
C     Generates rate for reaction jj at temperature tt9 
c     using Thielmann et al. parameterization and parameters aa(jj)
...
C----------EVOLUTION PARAMETER.
      REAL    tt9,ttt9         !Temperature of photons (units of 10**9 K).
      REAL    ttt9m1,ttt913,ttt9m13,ttt953         !Temperature coefficients
...
c----------- PROBLEM WITH REACLIB RATES AT HIGH TEMPERATURES T9> 10
C set REACLIB style rates equal to their value at T9=10
C for any temperature higher than T9=10
C this is justified because system is in NSE and strong 
C rates do not change NSE


c      ttt9=tt9   ! no modification !
      ...
      onethrd = 1.0/3.0
      ttt9m1  = 1.0/ttt9                 !t9**(-1)
      ttt913  = ttt9**onethrd           !t9**(1/3)
      ttt9m13  = 1.0/ttt913              !t9**(-1/3) [this is new!]
      ttt953  = ttt9*ttt913*ttt913         !t9**(5/3)
